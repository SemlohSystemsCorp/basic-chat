...
export const metadata: Metadata = {
  title: 'Cookie Policy',
  description: 'Chatterbox Cookie Policy — Understand how we use cookies on the Chatterbox platform and how to manage them.',
  openGraph: {
    title: 'Cookie Policy | Chatterbox',
    description: 'Learn about cookies used on the Chatterbox platform.',
  },
};
...
export default function CookiesPage() {
  const raw = readFileSync(join(process.cwd(), 'public', 'cookies.txt'), 'utf-8');
