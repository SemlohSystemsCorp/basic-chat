...
export const metadata: Metadata = {
  ...
  description: 'Chatterbox Terms of Service — Read our terms and conditions for using the Chatterbox communication platform.',
  openGraph: {
    title: 'Terms of Service | Chatterbox',
    description: 'Read the Chatterbox Terms of Service.',
  },
};
...
export default function TermsPage() {
  const raw = readFileSync(join(process.cwd(), 'public', 'terms.txt'), 'utf-8');
